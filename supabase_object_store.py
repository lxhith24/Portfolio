...
SUPABASE_URL = "https://uleaajlayhigsvtgzino.supabase.co"
SUPABASE_KEY = "sb_publishable_00yEfsoMSYKW9VSJhSOdLw_py26rJLW" 

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = "P/Users/lohith/Desktop/CC-Lab1/PES1UG23CS332.jpg"  # Replace with the local image path
image_name = "PES1UG23CS332.jpg"  # Desired name for the uploaded file
